...
int main(int argc, char *argv[])
{
    ...
    // 初始化日志
    int logRange = g_configure_service.getLogRange();
    ...
    // 系统托盘
    qmlRegisterType<MyMenu>("webClient.net.pc", 1, 0, "MyMenu");
    qmlRegisterType<MyAction>("webClient.net.pc", 1, 0, "MyAction");
    qmlRegisterType<MySeparator>("webClient.net.pc", 1, 0, "MySeparator");
    qmlRegisterType<SystemTrayIcon>("webClient.net.pc", 1, 0, "SystemTrayIcon");
    qmlRegisterType<SystemCursorDeal>("webClient.net.pc", 1, 0, "SystemCursorDeal");


    // 注册页面对象
    qmlRegisterSingletonType<App>("webClient.net.pc",
                                  1,
                                  0,
                                  "AppId",
    ...
    qmlRegisterSingletonType<GlobalHandler>("webClient.net.pc",
                                            1,
                                            0,
                                            "GlobalHandlerId",
    ...
    // 注册页面事件
    qmlRegisterType<MainHandler>("webClient.net.pc", 1, 0, "MainHandler");
